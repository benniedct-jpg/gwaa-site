...
export default function NotFound() {
  return (
    <div style={{ minHeight: '80vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 40, textAlign: 'center' }}>
      <div style={{ fontFamily: "'SF Mono', 'Menlo', 'Monaco', 'Consolas', 'Courier New', monospace", fontSize: 10, letterSpacing: '0.14em', color: '#16a34a', marginBottom: 16 }}>404 — NOT FOUND</div>
      <h1 style={{ fontFamily: "'Bebas Neue', cursive", fontSize: 'clamp(60px, 15vw, 120px)', color: '#111', lineHeight: 0.9, letterSpacing: '0.02em', marginBottom: 24 }}>
